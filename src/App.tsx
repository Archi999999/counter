...
function App() {
    ...
    return (
        <div className="App">
            <CounterSetting setting={setting} maxValue={maxValue} startValue={startValue}
                            changeStartValue={changeStartValue} changeMaxValue={changeMaxValue}
                            disabledSet={disabledSet}
            />
            <Counter value={currentValue} increment={increment} reset={reset} disabledInc={disabledInc}
                     disabledRes={disabledRes} error={error}/>
        </div>
    );
}
